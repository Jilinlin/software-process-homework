...
export default class Diannext extends React.Component {
    ...
    render(){
        if(this.state.ranqi){
            ...
            let message="燃气费";
            return <Redirect to={{pathname:"/payment",state:{jine:jine,goback:"rannext",danwei:danwei,huhao:huhao,message:message}}}/>
        }
        return(
            <div style={{height:"812px",background:"#F4F3F3"}}>
                ...
                <div style={{background:"#fff"}}> 
                    <div className="diannexttitle">
                        <div className="icon">
                            <i style={{fontSize:35,color:"white"}} className='iconfont icon-huo'></i>
                        </div>
                        <span className="dianfeispan">燃气费</span>
                    </div>
                    ...
                    <div className="nextcontent">
                        ...
                        <li className="nextli">
                            ...
                            <li className="nextli">
                                <span className="lileft">当前可用余额</span><span className="liright">50.00</span>
                            </li>
                            <li className="nextli">
